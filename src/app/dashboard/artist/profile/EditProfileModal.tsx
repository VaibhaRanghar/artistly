    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
          <div
            className="bg-[#111] w-full max-w-xl p-8 border-2 border-white/20 relative"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="grid gap-2">
                  ...
                  <input
                    name="languages"
                    defaultValue={initialLanguages.join(", ")}
              ...
              <div className="grid gap-2">
                <label className="text-xs font-bold uppercase tracking-wider text-white/60">
                  Skills / Categories (comma separated)
                </label>
                <input
                  name="skills"
                  defaultValue={initialSkills.join(", ")}
                  placeholder="e.g. Guitar, Vocals, DJ"
                  className="bg-[#0d0d0d] border-2 border-white/10 text-white px-4 py-3 text-sm font-medium focus:border-[#f5e642] outline-none transition-colors w-full"
                />
              </div>
