    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
          <div className="bg-[#111] w-full max-w-lg p-8 border-2 border-white/20 relative" style={{ boxShadow: "8px 8px 0px 0px #f5e642" }}>
            <button
            ...
            <p className="text-[#f5e642] font-mono text-xs uppercase tracking-widest mb-2">// new service</p>
            <h2 className="text-2xl font-black text-white mb-6">CREATE GIG</h2>

            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid gap-2">
                <label className="text-xs font-bold uppercase tracking-wider text-white/60">Gig Title</label>
                <input name="title" placeholder="e.g. Professional Jazz Performance" required
              ...
              <div className="grid gap-2">
                ...
                <textarea name="description" placeholder="Describe what you offer..." required rows={3}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="grid gap-2">
                  <label className="text-xs font-bold uppercase tracking-wider text-white/60">Price ($)</label>
                  <input name="price" type="number" step="0.01" required
                    className="bg-[#0d0d0d] border-2 border-white/10 text-white px-4 py-3 text-sm font-medium focus:border-[#f5e642] outline-none transition-colors w-full" />
                </div>
                <div className="grid gap-2">
                  <label className="text-xs font-bold uppercase tracking-wider text-white/60">Delivery (Days)</label>
                  <input name="deliveryTime" type="number" required
                    className="bg-[#0d0d0d] border-2 border-white/10 text-white px-4 py-3 text-sm font-medium focus:border-[#f5e642] outline-none transition-colors w-full" />
                </div>
              </div>
              <div className="grid gap-2">
