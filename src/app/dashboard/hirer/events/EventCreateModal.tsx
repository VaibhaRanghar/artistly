    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
          <div
            className="bg-[#111] w-full max-w-lg p-8 border-2 border-white/20 relative max-h-[90vh] overflow-y-auto"
          ...
          >
            ...
            <p className="text-[#ff2a6d] font-mono text-xs uppercase tracking-widest mb-2">
              {"// post event"}
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid gap-2">
                ...
                <textarea
                  name="description"
                  placeholder="Describe event and artist requirements..."
                  required
                  rows={3}
